...
CREATE TABLE `expense_type` (
  ...
  `code` varchar(18) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `expenses` (
  ...
  `reference_no` varchar(18) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `products` VALUES (8,1,'123','coffee','mondolkiri','coffee',4,1.25,1,'upload_image-1745073538026-552290675','admin','2025-01-27 06:27:48',0.00,1,NULL),(9,13,'123','tea','mondolkiri','soft_drink',6,2.00,1,'upload_image-1745073557495-797544134','ranh','2025-04-04 05:44:16',0.00,1,NULL),(12,13,'123','green tea','arabia','hot drink',7,2.00,1,'upload_image-1745073625266-330630551','ranh','2025-04-09 16:37:32',0.00,NULL,NULL),(14,1,'P014','black_coffee','arabia','coffee',3,2.00,1,'upload_image-1745073636578-81175154','ranh','2025-04-15 15:51:50',0.00,NULL,NULL),(15,1,'P015','amazon','arabia','coffee',6,2.00,1,'upload_image-1745073658691-453329945','ranh','2025-04-15 17:19:56',0.00,NULL,NULL),(16,13,'P016','blue tea','green-tea','tea',3,1.25,1,'upload_image-1745073806980-119492351','ranh','2025-04-15 17:20:58',0.00,NULL,NULL),(19,1,'P017','amz','arabia','test',5,2.00,1,'upload_image-1745077744859-854754053','ranh','2025-04-19 15:49:04',0.00,NULL,NULL);
...
-- Dump completed on 2025-04-22 20:03:58
